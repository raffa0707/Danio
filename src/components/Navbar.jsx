...
const Navbar = () => {
  ...
  <div className="navbar py-7 flex item-center justify-between">
    <div className="logo">
        ...
        md:text-white">Portofolio DANIO</h1>
    </div>
    <ul
        ...
        rounded-br-2x1 rounded-bl-2xl md:bg-transparent transition-all md:transition-none z-40
        ${
        ...
        <li>
            <a href="#talent"className="sm:text-lg text-base font-medium">
                Talent
            </a>
        </li>
        <li>
